...
build-966228833:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-966228833-inproc

build-966228833-inproc: ../rtos.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-966228833 ../rtos.cfg
configPkg/compiler.opt: build-966228833
configPkg/: build-966228833
